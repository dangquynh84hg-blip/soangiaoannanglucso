...
<div class="main-header">
    ...
    <p>Tác giả: Đặng Văn Quỳnh - Trường PTDTBT Tiểu học Yên Thành - ĐT: 0826845984</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đặng Văn Quỳnh- Trường PTDTBT Tiểu học Yên Thành - ĐT: 0826845984</div>", unsafe_allow_html=True)
